...
pub const VideoTimeCode = struct {
    ...
    pub fn format(self: VideoTimeCode, writer: *std.Io.Writer) std.Io.Writer.Error!void {
...
pub const VideoTimeCodeInterval = struct {
    ...
    pub fn format(self: VideoTimeCodeInterval, writer: *std.Io.Writer) std.Io.Writer.Error!void {
