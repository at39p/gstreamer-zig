...
pub const VideoFormatInfo = struct {
    ...
    pub fn component(self: VideoFormatInfo, plane: u32, components: []u32) u32 {
        return c_video.gst_video_format_info_component(self.ptr, plane, components.ptr);
    }

    pub fn extrapolateStride(self: VideoFormatInfo, plane: u32, stride: u32) u32 {
        return c_video.gst_video_format_info_extrapolate_stride(self.ptr, plane, stride);
    }
    ...
    pub fn getPStride(self: VideoFormatInfo, comp: u32) u32 {
        return @intCast(self.ptr.*.pstride[@intCast(comp)]);
    }
