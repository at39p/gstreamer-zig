...
pub const Event = struct {
    ...
    /// Takes ownership of this event and returns a writable version of it
    /// (which may be a copy). The original handle is consumed: its pointer
    /// is set to null, matching `gst_event_make_writable()` semantics.
